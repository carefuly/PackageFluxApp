...
type Detail struct {
	...
	AppleId     string   `gorm:"type:varchar(50);not null;comment:appleId" json:"appleId"`
	...
	VersionID   int      `gorm:"type:int;comment:版本ID" json:"version_id"`
	Version     Version  `gorm:"foreignKey:VersionID;constraint:OnDelete:CASCADE;"`
}
