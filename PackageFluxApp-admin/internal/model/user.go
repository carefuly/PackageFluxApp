...
type User struct {
	...
	Email       sql.NullString `gorm:"type:varchar(50);unique;column:email;comment:邮箱" json:"email"`             // 邮箱
	...
	Phone       sql.NullString `gorm:"type:varchar(20);unique;column:phone;comment:手机号" json:"phone"`            // 手机号
