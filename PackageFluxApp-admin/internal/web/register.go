...
func NewRegisterHandler(rely config.RelyConfig, svc service.RegisterService,
...
func (h *registerHandler) RegisterRoutes(router *gin.RouterGroup) {
	router.POST("/send-register-captcha", h.SendEmailCaptchaHandler)
	router.POST("/email-register", h.EmailRegisterHandler)
}

func (h *registerHandler) SendEmailCaptchaHandler(ctx *gin.Context) {
