...
enum API {
  ...
  SET_FORMAL = "/v1/application/version/updateFormal/",
...
// 删除
export const deleteById = (id: any, detailId: any) => sky.delete(API.DELETE + id + "?detailId=" + detailId);

// 更新
export const updateById = (id: any, data: any) => sky.put(API.UPDATE + id, data);

// 设置正式版
export const setFormal = (id: any, detailId: any) => sky.put(API.SET_FORMAL + id + "?detailId=" + detailId);

// 列表查询
export const listAll = (data: any) => sky.get(API.LIST_ALL, data);

// 根据ID进行查询
export const getById = (id: any, data: any) => sky.get(API.GET_BY_ID + id, data);
