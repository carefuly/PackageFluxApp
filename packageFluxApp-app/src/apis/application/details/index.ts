...
// 统一管理接口
enum API {
  ADD = "/v1/application/detail/create",
  DELETE = "/v1/application/detail/delete/",
  UPDATE = "/v1/application/detail/update/",
  GET_BY_ID = "/v1/application/detail/getById/",
  LIST_ALL = "/v1/application/detail/listAll",
}
